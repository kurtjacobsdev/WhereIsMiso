...
public class AppDependencies: MainCoordinatorDependencies {
    // Repositories
    public var firebaseFirestoreDataRepository: DataRepository = FirebaseFirestoreDataRepository()
    ...
    public lazy var locationWorker: LocationWorker = FirebaseLocationWorker(repository: firebaseFirestoreDataRepository)
